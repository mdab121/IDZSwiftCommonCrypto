...
public class PBKDF
{
    ...
    ///
    public class func calibrate(_ passwordLength: Int, saltLength: Int, algorithm: PseudoRandomAlgorithm, derivedKeyLength: Int, msec : UInt32) -> UInt
    {
    ...
    ///
    public class func deriveKey(_ password : String, salt : String, prf: PseudoRandomAlgorithm, rounds: uint, derivedKeyLength: UInt) -> [UInt8]
    {
    ...
    /// -returns: the derived key
    ///
    public class func deriveKey(_ password : String, salt : [UInt8], prf: PseudoRandomAlgorithm, rounds: uint, derivedKeyLength: UInt) -> [UInt8]
    {
        var derivedKey = Array<UInt8>(repeating: 0, count: Int(derivedKeyLength))
    ...
    ///
    public class func deriveKey(_ password: UnsafePointer<Int8>, passwordLen: Int, salt: UnsafePointer<UInt8>, saltLen: Int, prf: PseudoRandomAlgorithm, rounds: uint, derivedKey: UnsafeMutablePointer<UInt8>, derivedKeyLen: Int)
    {
